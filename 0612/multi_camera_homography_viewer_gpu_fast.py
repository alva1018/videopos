...
def main() -> int:
    ...
    while True:
        ...
        tracker.draw_text(cv2, grid, f"GPU viewer FPS:{display_fps:.1f}", (18, grid.shape[0] - 18), (0, 255, 255), 0.7)
        floorplan = draw_multi_camera_floorplan(cv2, floorplan_static, config, observations, fused)
